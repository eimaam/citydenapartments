...
const roles: RolePermission[] = [
  {
    ...
    icon: Shield,
    color: '#d4af37',
    summary: 'Full, unrestricted access to every part of the system across all branches.',
    pages: [
      { name: 'Dashboard', description: 'Revenue overview with period filters, KPI cards, CSV/PDF export' },
      { name: 'Branches', description: 'Add, edit, or remove hotel locations' },
      { name: 'Departments', description: 'Create and manage departments across branches' },
      ...
      { name: 'Calendar', description: 'Monthly view of bookings, arrivals, and departures' },
      ...
      { name: 'Inventory', description: 'Full inventory management — items, stock, transactions, write-offs' },
      { name: 'Discount Codes', description: 'Generate and manage promo codes (up to 50%)' },
      { name: 'Department Expenses', description: 'View and manage departmental expenses' },
      { name: 'Audit Logs', description: 'View system-wide audit trail of all actions' },
    ...
    can: [
      ...
      'View and manage department expenses',
  ...
  },
  {
    ...
    icon: Eye,
    color: '#8b5cf6',
    summary: 'Oversight across all branches with limited write access. Can view most data and manage operations.',
    pages: [
      { name: 'Dashboard', description: 'Revenue overview with period filters, KPI cards, CSV/PDF export' },
      { name: 'Departments', description: 'View and manage departments across branches' },
      ...
      { name: 'Bookings', description: 'View, create, and manage bookings' },
      { name: 'Calendar', description: 'Monthly view of bookings, arrivals, and departures' },
      { name: 'Breakfast', description: 'View breakfast logs across all branches' },
      { name: 'Employees', description: 'View employee records' },
      { name: 'Inventory', description: 'View-only — items, stock levels, transaction history' },
      { name: 'Discount Codes', description: 'Generate promo codes (up to 50%)' },
      { name: 'Department Expenses', description: 'View departmental expenses (read-only)' },
      { name: 'Audit Logs', description: 'View system-wide audit trail' },
      { name: 'Roles', description: 'View role documentation' },
    ],
    can: [
      'View reports and analytics across all branches',
      'View and manage departments (create, edit, soft-delete)',
      'View rooms, room types, and pricing across all branches',
      'View bookings and create new ones',
      'Cancel reservations',
      'Generate discount codes up to 50%',
      'View employees across all branches',
      'View inventory items, stock levels, and transaction history',
      'View department expenses (read-only)',
      'View audit logs',
    ],
    cannot: [
  ...
  },
  {
    ...
    icon: Building2,
    color: '#3b82f6',
    summary: 'Runs daily operations and oversees branch finances. Has financial dashboard access.',
    pages: [
      { name: 'Dashboard', description: 'Financial dashboard with revenue analysis, KPI cards, period filters, CSV/PDF export' },
      { name: 'Bookings', description: 'View bookings and manage reservations' },
      { name: 'Calendar', description: 'View booking calendar and room occupancy' },
      { name: 'Rooms', description: 'View rooms and update their status' },
      { name: 'Customers', description: 'View and manage guest records' },
    ...
    can: [
      'View financial dashboard with revenue KPIs, daily trends, and period filtering',
      ...
      'View department expenses (read-only financial oversight)',
  ...
  },
  {
    ...
    icon: ClipboardList,
    color: '#f59e0b',
    summary: 'Manages front desk operations — views booking logs, calendar, and customer records.',
    pages: [
      { name: 'Dashboard', description: 'See arrivals, occupancy, and booking metrics for their branch' },
      { name: 'Bookings', description: 'View booking logs and history (read-only)' },
      { name: 'Calendar', description: 'View monthly booking calendar and who\'s in-house' },
      { name: 'Rooms', description: 'View room statuses and update them' },
      { name: 'Customers', description: 'View and manage guest records' },
      { name: 'Discount Codes', description: 'Generate promo codes (up to 10%)' },
    ],
    can: [
      'View dashboard with arrivals, occupancy, and booking metrics',
      'View booking logs and history',
      'View the booking calendar to see who\'s in-house',
      'Update room statuses',
      'View and manage customer/guest records',
      'Generate discount codes up to 10%',
      'See today\'s arrivals and current occupancy',
    ],
    cannot: [
      'Create, edit, or cancel reservations (view-only for logs)',
      'Check guests in or out',
  ...
  },
  {
    ...
    color: '#06b6d4',
    summary: 'Handles financial records, inventory valuation, and expense tracking.',
    pages: [
      { name: 'Dashboard', description: 'Full financial dashboard — revenue analysis, payment methods, booking status, inventory glance, CSV/PDF export' },
    ...
    can: [
      'View financial dashboard with revenue KPIs, daily trends, payment method breakdown, booking status grid',
      'Filter revenue by period (daily, week, month, 3M, 6M, custom range)',
      ...
      'View transaction history and daily stock snapshots',
      'View and manage department expenses',
    ],
    cannot: [
  ...
  },
  {
    ...
    pages: [
      ...
      { name: 'Calendar', description: 'View the booking calendar' },
      { name: 'Rooms', description: 'View room statuses and update them' },
    ],
    can: [
  ...
  },
  {
    ...
    icon: Monitor,
    color: '#6366f1',
    summary: 'Manages user accounts, departments, rooms, and system configuration. No access to operational data.',
    pages: [
      { name: 'Dashboard', description: 'See system overview stats' },
      ...
      { name: 'Customers', description: 'View customer/guest records' },
      { name: 'Department Expenses', description: 'View departmental expenses (read-only)' },
      { name: 'Audit Logs', description: 'View system-wide audit trail' },
      { name: 'Roles', description: 'View role documentation' },
    ],
