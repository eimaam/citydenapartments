...
export const AbujaPage = () => {
  ...
  return (
    <div className="flex flex-col bg-[#FAF8F6]">
                  ...
                  <article onClick={() => setDetailRoom(suite)} className="group flex flex-col bg-white border border-outline-variant/35 p-3 rounded-sm shadow-card hover:shadow-ambient transition-all duration-500 cursor-pointer">
                    ...
                    <div className="mt-6 flex flex-col px-2 pb-2">
                      ...
                      <div className="mt-6 flex items-center justify-between border-t border-outline-variant/30 pt-4">
                        ...
                        <Link to="/book?city=abuja" onClick={(e) => e.stopPropagation()} className="text-xs font-bold tracking-widest text-[#735c00] hover:text-[#554300] border-b border-[#735c00]/30 hover:border-[#554300]/80 pb-0.5 uppercase transition-colors">
                          BOOK NOW
                        </Link>
                      </div>
                    </div>
      ...
      <RoomDetailDrawer room={detailRoom} onClose={() => setDetailRoom(null)} branchCode="abuja" />
    </div>
  );
};
