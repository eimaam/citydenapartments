...
import { Plus, Eye, Receipt, Building2, Printer, Filter } from 'lucide-react';
...
export default function DepartmentExpensesPage() {
  ...
  const canWrite = can(user, [UserRole.Accountant, UserRole.SuperAdmin, UserRole.GroupGM, UserRole.FacilityManager]);
    ...
    <div className="p-6 md:p-8 space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-outline mt-0.5">
              Log, track, and audit operational expenses classified by Department and Expense Head.
            </p>
          </div>
        </div>
        <div className="flex items-center gap-2 shrink-0">
          ...
          {canWrite && (
            <Button variant="default" size="sm" onClick={handleOpenCreate} icon={<Plus size={14} />}>
              Log Expense
            </Button>
          )}
        </div>
