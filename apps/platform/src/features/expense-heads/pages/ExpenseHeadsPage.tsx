...
import { Plus, Search, Tag, CheckCircle, XCircle, Edit, DollarSign, Wallet } from 'lucide-react';
  ...
  return (
    <div className="p-6 md:p-8 space-y-6">
      ...
      <div className="flex items-center gap-3">
        ...
        <span className="text-xs font-bold tracking-[0.15em] uppercase text-outline">Settings & Accounting</span>
      </div>
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-outline mt-1">
            Manage Revenue Heads (Cost of Sales) and Expenditure Heads (Operational & Overhead Expenses).
          </p>
        </div>
