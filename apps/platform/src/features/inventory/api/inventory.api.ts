...
export const inventoryApi = {
  ...
  createItem: (data: { name: string; departmentId: string; category: string; description?: string; unit: string; currentStock: number; reorderLevel: number; unitPrice: number; expiryDate?: string }) =>
    api.post<InventoryItem>('/inventory/items', data),
  updateItem: (id: string, data: { name?: string; departmentId?: string; category?: string; description?: string; unit?: string; reorderLevel?: number; unitPrice?: number; expiryDate?: string; isActive?: boolean }) =>
