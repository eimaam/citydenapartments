...
import { Plus, Search, Banknote, CreditCard, Building2, Users, Calendar } from 'lucide-react';
import {
  Button, Input, Select, Table, Option, Drawer, Badge,
  BookingStatus, PaymentMethod, BookingSource,
...
export default function BookingsPage() {
  ...
  const openCreate = async () => {
    try { setRooms(await roomsApi.list('available')); }
        ...
        {showDetail && (
          <div className="space-y-5">
            <div className="flex items-center justify-between">
              <div><p className="text-xs text-outline">Reference</p><p className="font-mono font-medium">{showDetail.bookingReference}</p></div>
            ...
            <div className="flex gap-3 pt-2">
              ...
              {(showDetail.bookingStatus === 'Confirmed' || showDetail.bookingStatus === 'Checked_In') && (
